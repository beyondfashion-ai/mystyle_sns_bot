# KALEI - Codex Agent Instructions
...
KALEI SNS automation bot. Posts AI fashion K-POP magazine content to X(Twitter) and Instagram automatically.
...
1. **Bot Disclosure:** Every post MUST include `(Generated by KALEI AI)` footer
