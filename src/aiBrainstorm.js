...
## 핵심 규칙
1. **K-POP 50 + 패션 50**: 반드시 K-POP 맥락(아티스트/컴백/활동)과 패션 분석(스타일 요소)을 균형있게 포함.
2. 강한 오프닝: 숫자/팩트/대비로 시작. 감정적 감탄사 금지.
3. 본문 3단계: K-POP 맥락 → 패션 분석 → 팬 적용 포인트.
...
[컨셉 설명]: (K-POP 맥락 + 패션 분석 앵글)
[프롬프트 원문]: (봇이 치환할 본문. {artist} 사용. K-POP 맥락 + 패션 분석 + 팬 참여 유도 + my-style.ai CTA 필수.)
------------------
`;
