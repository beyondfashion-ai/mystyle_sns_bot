...
const URL_VALIDATION_TIMEOUT_MS = 10000;
...
function buildSafeText(text) {
    let safeText = text || '';
    if (!safeText.includes('(Generated by KALEI AI)')) {
        safeText += BOT_DISCLOSURE;
    }
    if (!safeText.includes('(AI-generated fan-art editorial)')) {
        safeText += EDITORIAL_DISCLOSURE;
    }
    return safeText;
}
